  ...
  return (
    <section id="pricing" className="relative w-full bg-[#F6F5F1] p-12">
      <div className="mx-auto max-w-[95vw] px-4 py-20 md:py-32">
        ...
        >
          {TIERS.map((tier) => {
            const previewFeatures = tier.features.slice(0, PREVIEW_FEATURES);
            const restFeatures = tier.features.slice(PREVIEW_FEATURES);

            const cardBase = `group relative flex h-full ${MIN_CARD_H} flex-col border-2 border-[#E4E4E7] bg-[#FFFFFF] p-6 transition-colors duration-200 md:p-8`;
            const cardHover =
              "hover:bg-[#111827] hover:text-white hover:border-[#111827]";
            ...
            const buttonPrimary =
              "border-[#111827] bg-[#111827] text-white hover:scale-105 active:scale-95 group-hover:border-[#DFE104] group-hover:bg-[#DFE104] group-hover:text-[#111827]";
            ...
            return (
              ...
              >
                ...
                {/* Divider */}
                <div className="my-6 h-px w-full bg-[#E4E4E7] transition-colors duration-200 group-hover:bg-white/20" />
                ...
                <div>
                  ...
                  {tier.finePrint ? (
                    <p className="my-12 text-base leading-tight font-bold text-[#52525B] transition-colors duration-200 group-hover:text-white/70 md:text-lg">
                      {tier.finePrint}
                    </p>
                  ) : null}

                  {tier.timeline ? (
                    <p className="text-md mt-3 font-bold tracking-tight text-[#52525B] uppercase transition-colors duration-200 group-hover:text-white/70">
                      {tier.timeline}
                    </p>
                  ) : null}
                </div>
                ...
                {restFeatures.length > 0 ? (
                  <p className="mt-5 text-sm font-bold tracking-tight text-[#52525B] uppercase transition-colors duration-200 group-hover:text-white/70">
                    Includes:{" "}
