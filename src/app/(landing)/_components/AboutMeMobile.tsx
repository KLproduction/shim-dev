...
const AboutMeMobile = (props: Props) => {
  // 技術棧 logo 資訊
  const techStack = [
  ...
  const zMoveLeft = useTransform(scrollYProgress, [0.6, 0.7], [0, 500]);
  const opacityTextleft = useTransform(scrollYProgress, [0.6, 0.95], [1, 0]);

  const rotateYRight = useTransform(scrollYProgress, [0.5, 0.8], [0, -70]);
      ...
      <div className="bg-background relative h-[250vh] w-full" ref={sectionRef}>
        <div className="h-full w-full">
          ...
          >
            ...
            >
              <div className="flex h-full w-full flex-col items-center justify-center gap-6 rounded-2xl p-8 md:p-20">
