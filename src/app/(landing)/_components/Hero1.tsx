...
//   // Create controlsArray with one useAnimationControls per letter, using useMemo to avoid calling hooks in a callback
//   const controlsArray = React.useMemo(
//     () => Array.from({ length: sideWord.length }, () => useAnimationControls()),
//     [],
//   );
